...
// System.JSON, System.Net.Mime ,System.Net.HttpClient

uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes,
  Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls,
  UWrpTelegramBot, // Error เพราะหาไม่เจอ Add Search path ของ Project
  UWrpTelegramBot_type,
  System.JSON,
  System.Net.Mime , System.Net.HttpClient ,
  Vcl.ExtCtrls, Vcl.ComCtrls,
  Vcl.Buttons ;

type
  TFrmMainWrpTelegramBot = class(TForm)
    btnGetUpdates: TBitBtn;
    btnGetMe: TBitBtn;
    edChatID: TEdit;
    edChatTitle: TEdit;
    edToken: TEdit;
    ...
    mmChatBox: TMemo;
    TabSheet4: TTabSheet;
    btnSendPhoto: TBitBtn;
    edPhoto: TEdit;
    btnSendSticker: TBitBtn;
    edSticker: TEdit;
    btnSendVideo: TBitBtn;
    edVideo: TEdit;
    RzPageControl2: TPageControl;
    TabSheet5: TTabSheet;
    ScrollBoxChat: TScrollBox;
    edPhotoCaption: TEdit;
    TabSheet7: TTabSheet;
    mmResponse: TMemo;
    TabSheet8: TTabSheet;
    TabSheet9: TTabSheet;
    btnSendDocument: TBitBtn;
    edDocumentFileName: TEdit;
    edDocumentCaption: TEdit;
    OpenDialog1: TOpenDialog;
    Label4: TLabel;
    btnSelectFile: TBitBtn;
    btnSendMessageWBTN: TBitBtn;
    pnChatCount: TPanel;
    Label8: TLabel;
    Label9: TLabel;
    ...
    RzBitBtn1: TBitBtn;
    btnSendMessageWKB: TBitBtn;
    Label10: TLabel;
    edWebHook: TEdit;
    RzBitBtn2: TBitBtn;
    RzBitBtn3: TBitBtn;
    RzBitBtn4: TBitBtn;
    btnSendMessage2: TBitBtn;
    btnSendMessage3: TBitBtn;
    btnSendDice: TBitBtn;
    btnSendSlot: TBitBtn;
    btnSendBowling: TBitBtn;
    btnSendDart: TBitBtn;
    btnSendBall: TBitBtn;
    btnSendBase: TBitBtn;
    btnSendGame: TBitBtn;
